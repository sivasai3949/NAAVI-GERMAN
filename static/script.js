...
document.getElementById("theme-toggle").addEventListener("click", function () {
  ...
  document
    .querySelectorAll(".intro-bubble")
    .forEach((el) => el.classList.toggle("dark-mode"));
  document.querySelector(".chat-container").classList.toggle("dark-mode");
  document
    .querySelectorAll(".robot-bubble")
    .forEach((el) => el.classList.toggle("dark-mode"));
  document
    .querySelectorAll(".user-bubble")
    .forEach((el) => el.classList.toggle("dark-mode"));
  document.querySelector("textarea").classList.toggle("dark-mode");
  document.getElementById("send-btn").classList.toggle("dark-mode");
  document.getElementById("pathway-btn").classList.toggle("dark-mode");
});
